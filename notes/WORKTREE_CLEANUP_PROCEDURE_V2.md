...
- The main repo directory is accessible at `/home/pcalnon/Development/python/Juniper/juniper-deploy`
...
# Main repo
MAIN_REPO="/home/pcalnon/Development/python/Juniper/juniper-deploy"
```
...
gh pr create --repo pcalnon/juniper-deploy --base main --head "$OLD_BRANCH" \
